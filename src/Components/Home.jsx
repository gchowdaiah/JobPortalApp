      ...
      <section className="container py-5">
        ...
        <div className="row">
          ...
          <div className="col-md-4">
            <div className="card mb-4">
              <div className="card-body text-center">
                ...
                <p className="card-text">500 are actively hiring.</p>
                <Link
                  to="/companies"
                  className="btn btn-outline-primary btn-sm"
                >
          ...
          <div className="col-md-4">
            <div className="card mb-4">
              <div className="card-body text-center">
                ...
                <p className="card-text"> are actively hiring.</p>
                <Link
                  to="/companies"
                  className="btn btn-outline-primary btn-sm"
                >
          ...
          <div className="col-md-4">
            <div className="card mb-4">
              <div className="card-body text-center">
                <h5 className="card-title">Banking & Finanace</h5>
                <p className="card-text">250 are actively hiring.</p>
                <Link
                  to="/companies"
                  className="btn btn-outline-primary btn-sm"
                >
